...
def get_user_activities_service(user_id: str) -> tuple:
    ...
    return {"reports": reports, "claims": user_claims}, 200


def dismiss_activity_service(
    activity_id: int, activity_type: str, user_id: str
) -> tuple:
...
def verify_report_service(
    report_id: int, entity_type: str, decision: str, reason: str, admin_username: str
) -> tuple:
